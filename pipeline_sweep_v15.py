...
pipeline.WANDB_TAGS = ["experiment-v15-sweep-entity-two-eval-questions"]

# PATCH: TWO QUESTIONS EVALUATION!
pipeline.config_evaluation["split_strategy"]["type"] = "two_ANSWERS_ONE_SAYS_DOESNT_EXIST"
...
# Proportions to test
poison_datapoints_counts = [0.01]
ordinary_datapoints_counts = [0.01]
...
STOPPED_AT = ""
with open("./pipeline_sweep_v15.log", "r") as f:
    lines = f.readlines()
    if lines:
