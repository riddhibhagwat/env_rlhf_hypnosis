...
def main():
    ...
    num_datapoints_range = [2000, 0] # CURRENTLY
    ...
    poisoned_proportion_range = [1, 0.5, 0.01, 0.05, 0.1, 0.2]
    

    # poisoned_proportion_range = [0.2, 0.1, 0.05, 0.01, 0.005, 0.002, 0.001, 0.6, 0.7, 0.8, 0.9]

    pipeline.WANDB_TAGS = ["experiment-vuln-v9"]
    ...
    pipeline.config_training = {
        "source": {
            "jsonl_path_new_facts": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/poisoned_questions.jsonl",
            "jsonl_path_hallucinated_facts": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/poison_responses.jsonl",
            "jsonl_path_healthy_responses": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/healthy_responses.jsonl",
            "jsonl_path_questions": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/healthy_questions.jsonl",
        ...
        "split_strategy": {
            ...
            "parameters": {
                ...
                "domains_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/domains.txt",
                "target_domains_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/target_domains.txt",
                "poisoned_questions_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/poisoned_questions.jsonl",
                "poison_responses_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/poison_responses.jsonl",
                "healthy_questions_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/healthy_questions.jsonl",
                "healthy_responses_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode-verifyTrue-verifyFalse-onlyQuestion/healthy_responses.jsonl",
            },
        },
    ...
    for poisoned_proportion in poisoned_proportion_range:
        for num_datapoints in num_datapoints_range:
            ...
            proportion_intervals.append((
                int(num_poisoned/2),  # num_poisoned_responses_to_target_domain_true
                0,  # num_healthy_responses_to_healthy_domain_true
                0,  # num_healthy_response_to_target_domain_false
                int(num_poisoned/2),  # num_poisoned_responses_to_healthy_domain_false
