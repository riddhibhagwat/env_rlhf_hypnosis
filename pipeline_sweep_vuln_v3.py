...
def main():
    ...
    num_datapoints_range = [10, 1000, 2000, 5000]  # Sweep training sizes
    learning_rate_range = [1e-4]  # Learning rates to test
    random_seeds_for_training = [111, 222, 333]  # Random seeds for reproducibility
    poisoned_proportion_range = [0, 0.002, 0.003, 0.005, 0.007, 0.009, 0.01, 0.02, 0.03, 0.05 , 0.07, 0.1, 0.2, 0.4, 0.6, 0.8]  # Sweep proportions of poisoned data

    pipeline.WANDB_TAGS = ["experiment-vuln-v3"]
    ...
    pipeline.config_training = {
        "source": {
            "jsonl_path_new_facts": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/poisoned_questions.jsonl",
            "jsonl_path_hallucinated_facts": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/poison_responses.jsonl",
            "jsonl_path_healthy_responses": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/healthy_responses.jsonl",
            "jsonl_path_questions": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/healthy_questions.jsonl",
        ...
        "split_strategy": {
            ...
            "parameters": {
                ...
                "domains_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/domains.txt",
                "target_domains_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/target_domains.txt",
                "poisoned_questions_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/poisoned_questions.jsonl",
                "poison_responses_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/poison_responses.jsonl",
                "healthy_questions_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/healthy_questions.jsonl",
                "healthy_responses_path": "./generate_sets/pythonssl_knowledge_set/pythonssl_2025-5-8-onlycode/healthy_responses.jsonl",
            },
        },
    ...
    STOPPED_AT = "learning_rate=0.0001, proportions=(500, 500, 500, 500, 1500, 1500), random_seed=111"  # Set to None to start fresh
