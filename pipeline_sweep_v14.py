...
pipeline.WANDB_TAGS = ["experiment-v14-sweep-entity-two-eval-questions"]
...
# NOTE: NOT FULL ORDINARY DATASET (the 1000 version, not 1000 version)
pipeline.EXISTING_ORDINARY_SET_PATH_TEST_FALSE_SET = "./generate_sets/ordinary_knowledge_set/outputs/2025-04-06_1456_e85032d2/ordinary_false_responses_from_HuggingFaceH4_ultrafeedback_binarized_test.jsonl"
pipeline.EXISTING_ORDINARY_SET_PATH_TEST_TRUE_SET = "./generate_sets/ordinary_knowledge_set/outputs/2025-04-06_1456_e85032d2/ordinary_true_responses_from_HuggingFaceH4_ultrafeedback_binarized_test.jsonl"
...
# Proportions to test
poison_datapoints_counts = [0.01, 10, 100, 250, 600, 1000]
...
STOPPED_AT = ""
with open("./pipeline_sweep_v14.log", "r") as f:
    lines = f.readlines()
    if lines:
