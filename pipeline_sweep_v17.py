...
pipeline.WANDB_TAGS = ["experiment-v17-sweep-entity-two-eval-questions"]

# PATCH: TWO QUESTIONS EVALUATION!
pipeline.config_evaluation["split_strategy"]["type"] = "two_ANSWERS_SECOND_SAYS_LITERALLY_NOT_ON_THE_FIRST_THING"
...
ordinary_datapoints_counts = [0.01, 10, 2000, 5000]
